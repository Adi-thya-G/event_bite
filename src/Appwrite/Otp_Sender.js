...
import { Client, ID, Databases,  Query,Storage , Functions,Account ,ExecutionMethod,} from "appwrite";
...
export class Order_Place_Information{
  ...
  async Create_Order({delivery_date,status,address,contact,user,Number_of_Plates,Item_name,Alternative_Phone,delivery_time})
  {
    try {
